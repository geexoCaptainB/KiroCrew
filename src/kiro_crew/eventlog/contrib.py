...
class ExternalProjectionStore:
    ...
    def _flush(
        ...
        try:
            ...
            # this, pins the parent through one descriptor so no ancestor is
            # re-resolved between the check and the write, and creates that parent
            # on the way, which is why the ``mkdir`` this replaced is gone rather
            # than merely moved.
