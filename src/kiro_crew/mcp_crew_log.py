    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "answered; 'class' is what kind of session the log belongs to over "
                "its whole life, which is the fold the gateway itself consults "
                "before letting one session read another's log. Prefer this over "
