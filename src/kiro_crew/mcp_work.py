    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "character counts six bytes), so a report at every field cap with "
                "non-ASCII text can be refused work_entry_too_large before anything is "
                "written; keep summary and artifacts to what a reader needs."
            ),
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": (
                ...
                "one 64 KB crew-log line as JSON (a non-ASCII character counts six "
                "bytes), so a write at every field cap with non-ASCII text can be "
                "refused work_entry_too_large before anything is written."
            ),
            "inputSchema": {
                "type": "object",
                "properties": {
