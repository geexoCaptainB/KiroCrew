...
| [Jev Skill Selection](decisions.md) | Let a small fast model choose the automatic skill for a sampled conversation, and choose whether a message sent mid-turn steers or queues, falling back to the shipped behaviour whenever it cannot, and keep a basic log of the calls |
