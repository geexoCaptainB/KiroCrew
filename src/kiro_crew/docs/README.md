...
| [decisions.md](decisions.md) | Jev decisions: letting a small fast model pick the automatic skill for a sampled conversation, and pick whether a mid-turn message steers or queues, with the shipped behaviour as the fallback and a basic diagnostic log. |
