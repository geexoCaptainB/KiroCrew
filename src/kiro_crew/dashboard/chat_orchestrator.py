...
async def _cancel_stage_subagents(
    ...
    *,
    ...
    """Cancel exact captured stage children after their producer has stopped."""
    ...
    for parent_key in parent_keys:
        ...
        if callable(pending_reason):
            reason = pending_reason(parent_key, owner)
...
async def api_chat_plan_action(request: web.Request) -> web.Response:
    ...
    if action == "cancel":
        ...
        await _cancel_stage_subagents(state, slot, scope=scope)
