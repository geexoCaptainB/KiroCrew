...
async def rehydrate_slot_from_history_async(
    ...
    *,
    ...
    if _restored is not None:
        # Claim recovery belongs HERE, not in each caller: this function is the
        # only way anything outside this module rebuilds one slot from disk, and
        # it has eight such callers (members, messaging, files, two in the Slack
