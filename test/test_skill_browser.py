...
class TestSymlinkedSkillLeafContainment:
    ...
    def test_app_registered_leaf_links_still_resolve(self, fake_home):
        ...
        target is an app skill provider root, which is the same source the
        loader-side walk admits them with.
        """
        app_skill = fake_home / ".kiro" / "crew" / "apps" / "demo-app" / "skills" / "appy"
